...
void INTERACCION_default(void); /* Menú de manipulación del sonido */
void INTERACCION_askF(void); /* Menú de frecuencia fija */
void INTERACCION_askB(void); /* Menú de barrido */
...
unsigned char INTERACCION_analyzeInput (void); /* Verifica si lo recibido corresponde a una entrada válida */
unsigned char INTERACCION_getInput (void); /* Obtiene la entrada, correspondiente a la opción de menú, guardada en el buffer de recepción */
